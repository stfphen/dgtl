...
| `GOOGLE_PLACES_API_KEY` | console.cloud.google.com → Credentials | **restrict to Places API + server IP `37.27.198.189`**. ⚠️ Still allowlisted to the retired `[retired-vps]` — update when rotating, or Places fails in production. |
