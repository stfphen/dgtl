...
- **Google Places:** needs billing + Places permission; restrict key to Places API + server IP. ⚠️ **The allowlist still names the retired `[retired-vps]`** — set it to **`37.27.198.189`** or Places requests from production fail.
