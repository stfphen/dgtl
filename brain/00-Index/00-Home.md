...
- **Deploy target:** `dgtlmag.com` on Hetzner VPS `37.27.198.189` (host `DGTLapps`, Coolify edge; the Hostinger box `62.72.16.32` was offboarded 2026-07-21) — **LIVE at `main@32c9f73` (2026-07-04: template library — vertical presets, section variants, authority archetype; smoke green)**. Production tracks `main`. See `docs/DEPLOY_NEXT.md` / [[41-Deployment-Runbook]].
