...
| `os/` | `dgtl-os-local/` | DGTL OS assistant + terminal + knowledge ingest + hosting kit. `api-key.txt` excluded; `.env`/`api-key.txt` gitignored. Brain/data wiring documented in `os/README.md`. |
